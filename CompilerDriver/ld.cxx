...
#define kToolVersion "MP-UX linker v1.14, (c) Amlal El Mahrouss"
...
int main(int argc, char** argv)
{
    ...
    for (size_t i = 1; i < argc; ++i)
    {
        if (StringCompare(argv[i], "-h") == 0)
        {
            ...
            kStdOut << "-marc, -mrv64, -m64: Compile to specific ISA.\n";
        ...
        //
        else if (StringCompare(argv[i], "-m64") == 0)
        {
            kArch = CxxKit::kPefArchAMD64;
        ...
        else if (StringCompare(argv[i], "-mrv64") == 0)
        {
            kArch = CxxKit::kPefArchRISCV;
            kSubArch = 1;
    ...
    pef_container.Linker = kPefLinkerNumId; // Amlal El Mahrouss Linker
